...
const imageArray = [{src:React,name:"ReactJS"},{ src:<SiNextdotjs className='sicon'/>,name:"NextJS",icon:true},{src:JavaScript,name:"JavaScript"},{src:ThreeJs,name:"Three JS"},{src:ThreeJs,name:"R3F"},{src:nodejs,name:"Node.Js"},{src:<SiExpress className='sicon'/>,name:"Express.Js",icon:true},{src:Python,name:"Python"},{src:HTML,name:"HTML"},{src:CSS,name:"CSS"},{ src:mongoDB,name:"mongoDB"},{src:firebase,name:"Firebase"},]
